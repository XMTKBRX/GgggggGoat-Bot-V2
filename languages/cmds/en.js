module.exports = {
	...
	"batslap": {
		"description": "صورة الضربة",
		"text": {
			"noTag": "يجب عليك الإشارة إلى الشخص الذي تريد ضربه"
		}
	},
	"busy": {
		"description": "تشغيل وضع عدم الإزعاج، عند الإشارة إليك، سيقوم البوت بإخطار الآخرين",
	...
	"callad": {
		"description": "إرسال تقرير أو ملاحظات أو خطأ إلى مسؤول البوت",
		"guide": "   {pn} <رسالة>",
		"text": {
			"missingMessage": "يرجى إدخال الرسالة التي تريد إرسالها إلى المسؤول",
			...
			"reply": "📍 رد من المسؤول %1:\n─────────────────\n%2\n─────────────────\nرد على هذه الرسالة لمواصلة إرسال الرسائل إلى المسؤول",
	...
	"cmd": {
		...
		"guide": "{pn} load <اسم ملف الأمر>\n{pn} loadAll\n{pn} install <رابط> <اسم ملف الأمر>: تنزيل وتثبيت ملف أمر من رابط، الرابط هو مسار الملف (raw)",
		"text": {
			"missingFileName": "⚠️ | يرجى إدخال اسم الأمر الذي تريد إعادة تحميله",
			"loaded": "✅ | تم تحميل الأمر \"%1\" بنجاح",
			"loadedError": "❌ | فشل في تحميل الأمر \"%1\" بالخطأ\n%2: %3",
			...
			"unloaded": "✅ | تم تفريغ الأمر \"%1\" بنجاح",
			"unloadedError": "❌ | فشل في تفريغ الأمر \"%1\" بالخطأ\n%2: %3",
			...
			"installedError": "❌ | فشل في تثبيت الأمر \"%1\" بالخطأ\n%2: %3",
	...
	"count": {
		"description": "عرض عدد الرسائل لجميع الأعضاء أو نفسك (منذ انضمام البوت إلى المجموعة)",
		"guide": "   {pn}: يستخدم لعرض عدد الرسائل الخاصة بك\n   {pn} @tag: يستخدم لعرض عدد الرسائل للأشخاص المشار إليهم\n   {pn} all: يستخدم لعرض عدد الرسائل لجميع الأعضاء",
		"text": {
			...
			"result": "%1 في المرتبة %2 مع %3 رسائل",
			"yourResult": "أنت في المرتبة %1 وأرسلت %2 رسائل في هذه المجموعة",
	...
	"customrankcard": {
		...
		"guide": {
			"body": "   {pn} [maincolor | subcolor | linecolor | progresscolor | alphasubcolor | textcolor | namecolor | expcolor | rankcolor | levelcolor | reset] <القيمة>"
				...
				+ "\n  + textcolor <القيمة>: لون النص (hex color أو rgba)"
				+ "\n  + namecolor <القيمة>: لون الاسم"
				+ "\n  + expcolor <القيمة>: لون الخبرة"
				+ "\n  + rankcolor <القيمة>: لون الترتيب"
				+ "\n  + levelcolor <القيمة>: لون المستوى"
				+ "\n    • <القيمة> يمكن أن تكون لون hex، rgb، rgba، تدرج (كل لون مفصول بمسافة) أو عنوان URL للصورة"
				+ "\n    • إذا كنت تريد استخدام التدرج، يرجى إدخال ألوان متعددة مفصولة بمسافة"
				+ "\n   {pn} reset: إعادة تعيين كل شيء إلى الافتراضي"
				+ "\n   مثال:"
				+ "\n    {pn} maincolor #fff000"
		...
		"text": {
			"invalidImage": "عنوان URL للصورة غير صالح، يرجى اختيار عنوان URL لصورة (jpg، jpeg، png، gif)، يمكنك تحميل الصورة إلى https://imgbb.com/ واختيار \"الحصول على الرابط المباشر\" للحصول على عنوان URL للصورة",
